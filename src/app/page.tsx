...
const mockEvents: Event[] = [
	{
		...
		djLineup: [
			...
			},
			{
				...
				name: "Luna Eclipse",
				avatar:
					"https://images.unsplash.com/photo-1494790108755-2616b5e000ec?w=150&h=150&fit=crop&crop=face",
	...
	},
	{
		...
		videoUrl:
			"https://player.vimeo.com/video/271392047?background=1&autoplay=1&loop=1&byline=0&title=0",
		imageUrl:
